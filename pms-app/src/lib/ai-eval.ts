...
function buildPrompt(members: AiMemberInput[]): string {
  ...
  return [
    ...
    '  난도·중대성 판단에는 일반적인 직무·KPI 관점의 이론적 기준(업무가 얼마나 전문적/복잡하고, 전사·조직에 미치는 영향과 리스크가 큰지)을 활용하세요. 단, 이는 "목표 내용 자체의 난도·중요도"를 가늠하는 데만 쓰고, 실제 실적·완료 여부 등 사실은 반드시 제공된 데이터에 한정하며 없는 성과를 지어내지 마세요.',
    '  주간업무보고의 세부 추진내용(goals[].weeklyNotes, weeklyHighlights)은 ①효율성(투입 대비 산출·진척의 합리성) ②실효성(실제 성과·문제 해결로 이어졌는지) ③중대성(영향 범위·중요도) 관점에서 평가에 반영하세요. 단순 나열·형식적 기록보다 구체적이고 실질적 성과가 드러나는 기록을 높게 봅니다.',
