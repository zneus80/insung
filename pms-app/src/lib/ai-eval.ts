...
export const SHARED_EVAL_CRITERIA: string[] = [
  ...
  '- 순위·평가 비중은 다음 순서로 높게 둡니다: ①핵심목표의 난도 ②핵심목표 완료 실적(완료 수·완료율) ③유효 핵심목표의 갯수(포기 제외, 많을수록 높게). 진행률·기타 실적은 보조.',
  '  난도는 가중치만이 아니라 목표의 설명·범위와 주간 추진내용·진행률을 함께 보고 종합 추정하며, 일반적 직무·KPI 이론(전문성·복잡도·전사/조직 영향·리스크)도 활용합니다. 단 사실·실적은 제공된 데이터에 한정하고 없는 성과를 지어내지 않습니다.',
  ...
  '  · A(탁월함): 난도 높은 핵심목표를 다수 완료하는 등 성과가 명확히 두드러지는 최상위.',
  '  · B(우수함): 목표 달성도·실적이 평균을 분명히 상회.',
  '  · C(보통): 일반적인 수준의 성과(대부분의 인원이 여기에 해당).',
  '  · D(미흡): 목표 미달·포기가 많거나 난도 낮은 일반업무 중심으로 기대에 못 미침.',
  '  · E(미달): 성과 근거가 거의 전무한 수준.',
];
