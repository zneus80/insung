...
import { computePromotion, computeSmartProjectCounts, type PromotionInfo, type SmartProjectCount } from '@/lib/promotion';
...
// 승진요건 계산은 공용 모듈로 추출 — lib/promotion.ts (전사 인원현황·AI 챗봇 공유)
  ...
  useEffect(() => {
    (async () => {
      ...
      try {
        ...
        // 사용자별 스마트프로젝트 PM/멤버 카운트 — 공용 모듈
        const spCountByUser = computeSmartProjectCounts(allInnovations);
